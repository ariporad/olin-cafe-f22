...
- [x] Learn how to use generate statements to automate led_array logic for any size grid (see main.sv for example).
  - Sort of, we didn't implement an arbitrary-width decoder
...
Our circuit worked! ([The LEDs also worked.](docs/leds.mov))

![Video of our circuit working, running Conway's Game of Life][docs/conway.mov]

Our work is documented thoroughly throughout our code [and in our schematics][docs/schematics.png].